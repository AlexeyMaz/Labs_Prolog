...
%%% Задача 9 Построить все слова длины 5, в которых ровно одна буква повторяется 2 раза, остальные буквы не повторяются. Вывод в файл.
task9_writer :-
...
task9 :- tell('Labs_Prolog/Lab14/out_9.txt'), task9_writer; told.

%%% Задача 10 Построить все слова длины 6, в которых ровно 2 буквы повторяются 2 раза, остальные буквы не повторяются. Вывод в файл.
task10_writer :-
...
task10 :- tell('Labs_Prolog/Lab14/out_10.txt'), task10_writer; told.